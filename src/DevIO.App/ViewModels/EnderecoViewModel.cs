...
namespace DevIO.App.ViewModels
{
    public class EnderecoViewModel
    {
        ...
        [Required(ErrorMessage = "O campo {0} é obrigatório")]
        [StringLength(50, ErrorMessage = "O campo {0} precisa ter {2} e {1} caracteres", MinimumLength = 2)]
        ...
        [Required(ErrorMessage = "O campo {0} é obrigatório")]
        [StringLength(8, ErrorMessage = "O campo {0} precisa ter {2} e {1} caracteres", MinimumLength = 2)]
